...
\def\PHDTITLE {Search for Neutral MSSM Higgs Bosons \newline Decaying to Pairs of $\tau$
Leptons at \mbox{$\sqrt s=7~\text{Te\hspace{-.08em}V}$}} 
...
\def\PHDCOMMITTEEA{John Conway}
\def\PHDCOMMITTEEB{Robin Erbacher}
\def\PHDCOMMITTEEC{Mani Tripathi}
...
\newcommand{\signaturebox}[1]{\multicolumn{1}{p{2.5in}}{\vspace{3ex}}\\\midrule #1\\}
