...
\begin{figure}
  ...
  \caption[SM Higgs cross sections at the LHC]{Cross section of the SM Higgs
...
\begin{figure}
  ...
  \caption[SM Higgs branching fractions]{Branching fraction of the SM Higgs
...
When the parameter \tanb is large, the coupling factor between the Higgs and the
...
SM and MSSM Higgs boson.  Additionally, precision electroweak measurements
...
the predicted value of the SM\@.  For Higgs masses below $114~\GeVcc$, the
...
\begin{figure}
  ...
  \caption[LEP SM Higgs limit plot]{Combined LEP upper limit set on the quantity
...
limit on the SM Higgs from both Tevatron experiments is shown in
Figure~\ref{fig:TevatronLowMassHiggsLimit}.  The Tevatron currently sets an
upper limit on the SM Higgs cross section of about 2.5 times the SM
expectation.
\begin{figure}
  \centering
...
Figure~\ref{fig:TevatronHighMassHiggsLimit}) a SM Higgs with a mass
between 162 and 166~\GeVcc.  This is the first exclusion in SM Higgs
