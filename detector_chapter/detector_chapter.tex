...
\begin{figure}
  ...
  \label{fig:SubdetectorID} } \caption[Schematic drawings of the CMS
  detector]{Figure~\subref{fig:CMSDetector}, top, shows a schematic drawing of
  the CMS detector.  The individual sub--detectors are labeled.  Two humans are
  shown in the foreground for scale. Figure~\subref{fig:SubdetectorID} shows a
...
The expected (from simulation) transverse momentum
resolution of the tracker is approximately 1\%.  The
momentum scale of the tracker has been measured~\cite{CMS-PAS-TRK-10-004} in
7~\TeV 2010 CMS data using $\JPsi \to \MM$ decays and is found to agree with the
...
a noise term, and $C$ is a constant term.  
%The parameters of
%Equation~\ref{eq:ECALResolutionFormula} have been measured at an electron
%test--beam (see Figure~\ref{fig:ECALResolution}).  
The energy resolution is
better than 1\% for electron energies greater than 20~\GeV.  
%\begin{figure}
  %\centering
  %\includegraphics[width=0.6\textwidth]{detector_chapter/figures/ECAL_Energy_resolution_fixed.pdf}
...
\begin{figure}
  \centering
  \subfigure[]{\includegraphics[width=0.54\textwidth]{detector_chapter/figures/interaction_lengths_before_muon.pdf}
  \label{fig:PunchThroughProtectin} }
  \subfigure[]{\includegraphics[width=0.4\textwidth]{detector_chapter/figures/global_muon_reco_eff.pdf}
