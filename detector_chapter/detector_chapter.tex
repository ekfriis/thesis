...
\begin{figure}
  ...
  \caption{The left figure, \subref{fig:PunchThroughProtectin}, illustrates the
  number of interaction lengths versus pseudorapidity $\eta$ of material that
  must be traversed before reaching the different layers of the muon system.
  On the right, \subref{fig:GlobalMuonRecoEffJINST} shows the efficiency versus
  $\eta$ to reconstruct a ``global'' muon for different transverse momenta.}
\end{figure}
