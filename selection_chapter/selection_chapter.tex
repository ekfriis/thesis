...
\begin{figure}[t]
\begin{center}
  \subfigure[]{\includegraphics*[width=0.48\textwidth]{selection_chapter/figures/pzeta_graphic.pdf}
  \label{fig:PzetaDefinition} }
  \subfigure[]{\includegraphics*[height=0.48\textwidth,angle=90]{results_chapter/figures/replotted_results/plotZtoMuTauOS_inclusive_cutFlowControlPlots_PzetaDiff_afterMt1MET.pdf}
  ...
  Figure~\subref{fig:PzetaDefinition}.  Image credit:~\cite{CDFrefPzeta}
