...
significance of Higgs boson signal events in the final set of selected events.  This
analysis presented in this thesis is an inclusive analysis, meaning that no
preference is given to any single Higgs boson production mechanism.  The analysis
...
to find High Level Trigger selection that is highly efficient for the signal
...
triggered by a combination of muon and \mbox{muon + tau-jet} ``cross--channel''
...
discriminator against muons is applied~\cite{CMS-PAS-PFT-08-001}. Remaining
di--muon background is suppressed by rejecting events which have a track of $\pt
