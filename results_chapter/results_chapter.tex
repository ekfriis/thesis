...
nuisance?} using Monte Carlo techniques.  The pseudo--data sets are expected to
...
%
% Vim command to add column delimters between a
% 'a,'bs/\(\S\)\s\s*\(\S\)/\1 \& \2/g Round floating point numbers
% Round
