...
collision depends on the PDFs, the signal acceptance is sensitive to errors in
...
the profile likelihood.  Do determine the upper bound, we simply use Bayes' Theorem to
...
In the results in the next Chapter we use nuisance parameters corresponding
