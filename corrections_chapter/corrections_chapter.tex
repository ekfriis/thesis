...
confidently considered~\cite{CMS-PAS-TAU-11-001}\footnote{The tau energy scale
was roughly measured using the invariant mass of the hadronic decay products and
shown to be compatible with 1.0, within 3\%.} an upper limit, and is used in
